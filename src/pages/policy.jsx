  ...
  return (
    <PageLayout>
      <div className="flex flex-col gap-5">
        ...
        <div>
          <H3 className="">Welcome to PlaceXP!</H3>
          <p>
            This website is a multi-utility platform to facilitate all the
            VITians timely access to all the academic related resources and
            solve any queries related to the curriculum or co-curriculum, for
          ...
          <p>
            ...
            contact us at placexpvitc@gmail.com.
          </p>
        </div>
        <div>
          ...
          <ol className="list-decimal list-inside">
            <li>
              In order to use the Service, you must firstly agree to the Terms.
              You may not use the Service if you do not accept the Terms.
            </li>
            <li>
              You can accept the Terms by simply using the Service. You
              understand and agree that PlaceXP will treat your use of the
        ...
        <div>
          <H3>Who can use PlaceXP:</H3>
          Our platform is not just open and as inclusive as possible, but also
          is safe, secure and in accordance with VIT. Our website would be
        ...
        <div>
          ...
          <ol className="list-decimal list-inside">
            ...
            <li>
              You attempt to create accounts or access or collect information in
              unauthorized ways.
            </li>
          </ol>
        </div>
        <div>
          ...
          <ul>
            ...
            <li>
              Make available any threatening, harassing, abusing, obscene or
              hateful content
            </li>
        ...
        <div>
          <H3>The Content:</H3>
          <p>
            The PlaceXP Site includes a combination of content that we write or
            that is created and posted by our creative team. All of the content
            on the PlaceXP Site is protected by the copyright of PlaceXP, other
            content providers or our users. Materials uploaded to PlaceXP may be
            subject to posted limitations on usage, reproduction and/or
            dissemination.
          </p>
          <p>
            As a user of the PlaceXP Site, you may not modify, publish,
            ...
            or in any way exploit any of the content on the PlaceXP Site in
            whole or in part outside of the specific usage rights granted to
            you. If you download or print a copy of any PlaceXP content for
            personal use, you must retain all copyright and other proprietary
            notices contained therein. You may not otherwise use, reproduce,
            display, publicly perform, or distribute such content in any way for
            any public or commercial purpose unless such use is expressly
        ...
        <div>
          ...
          <p>
            ...
            costs and expense that the Member may suffer or incur, and no fees
            or charges payable by the Member to the PlaceXP shall be deducted,
            refunded or rebated, as a result of such deactivation or suspension.
          </p>
        </div>
        <div>
          <H3>Termination of Service:</H3>
          PlaceXP may terminate this Agreement with immediate effect, without
          prior notice to the Member/User and without further prejudice to all
          other rights:
          <ol className="list-decimal list-inside">
            <li>
              If in the opinion of PlaceXP, the Member has breached any of the
              terms or conditions of this agreement.
            </li>
            <li>
              If in the opinion of PlaceXP or any regulatory authority, it is
              not in the public interest to continue providing the Service to
              the Member for any reason.
            </li>
          </ol>
          The following could be deemed as the reason for the termination of the
          services:
          <ol className="list-decimal list-inside">
            <li>harasses or advocates harassment of another person</li>
            <li>
              is patently offensive to the online community, any such content
              that promotes racism, bigotry, hatred or physical harm of any kind
              against any group or individual
            </li>
            <li>
              involves unsolicited mass mailing or "spamming", the transmission
              of "junk mail", "chain letters": promotes any information that is
              misleading, is false or that promotes illegal activities or
              conduct that is abusive, threatening, obscene, defamatory or
              libellous
            </li>
            <li>
              promotes unauthorized or an illegal copy of another person's
            ...
            <li>
              ...
              illegal weapons, or providing or creating computer viruses, or
              hacking
            </li>
            <li>
          ...
          <p>
            <strong>
              Any kind of misbehaviour mentioned above, can lead to account
              suspension and might also lead to the involvement of VIT
              management.
            </strong>
          </p>
        </div>
        <div>
          ...
          <p>
            <strong>
              Thank you for taking the time to read this Terms Of Use. By
              following these Terms, the experience will be better for all
              users.
            </strong>
          </p>
          <p>
            <strong>Enjoy PlaceXP Services!</strong>
          </p>
        </div>
      </div>
    </PageLayout>
