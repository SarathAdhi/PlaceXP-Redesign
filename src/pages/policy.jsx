...
export default function Policy() {
  return (
    <PageLayout className="text-primary-900 items-stretch">
      ...
      <div className="text-justify mb-5">
        ...
        <P className="">Our platform is not just open and as inclusive as possible, but also is safe, secure and in accordance with VIT. Our website would be highly beneficial if you are-</P>
        <ol className="list-decimal my-2 ml-5">
          <li><P className="">A college student</P></li>
          <li><P className="">A person in the field of Engineering</P></li>
          <li><P className="">Wants exponential growth in your career and life</P></li>
        </ol>
      </div>
      ...
      <div className="text-justify mb-5">
        ...
        <P className="">PlaceXP may terminate this Agreement with immediate effect, without prior notice to the Member/User and without further prejudice to all other rights:</P>
        <ol className="list-decimal my-2 ml-5">
          <li><P className="">If in the opinion of PlaceXP, the Member has breached any of the terms or conditions of this agreement.</P></li>
          <li><P className="">If in the opinion of PlaceXP or any regulatory authority, it is not in the public interest to continue providing the Service to the Member for any reason.</P></li>
        </ol>
        <P className="">The following could be deemed as the reason for the termination of the services:</P>
        <ol className="list-decimal my-2 ml-5">
